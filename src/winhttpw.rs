...
pub enum AccessType {
    ...
    WINHTTP_ACCESS_TYPE_NAMED_PROXY = winapi::um::winhttp::WINHTTP_ACCESS_TYPE_NAMED_PROXY as isize,
...
pub fn WinHttpQueryDataAvailable(
    ...
    unsafe {
        b_results = winapi::um::winhttp::WinHttpQueryDataAvailable(hRequest.handle, dw_size_ptr);
    }
    if b_results != 1 {
        return Err(win32_error::Win32Error::new());
    } else {
